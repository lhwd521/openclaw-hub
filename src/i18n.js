...
const translations = {
  zh: {
    ...
    "cron.detail": "查看",
    "cron.remove": "删除",
    "cron.remove_confirm": "确定要删除这个定时任务吗？",
    "cron.job_removed": "任务已删除",
    "cron.remove_fail": "删除失败：",
  ...
  en: {
    ...
    "cron.detail": "Detail",
    "cron.remove": "Remove",
    "cron.remove_confirm": "Are you sure you want to remove this cron job?",
    "cron.job_removed": "Job removed",
    "cron.remove_fail": "Failed to remove: ",
